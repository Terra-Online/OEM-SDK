...
export const createManifest = (): OEMManifest => ({
  ...
  regions: [
    {
      ...
      floors: [
        { id: 'M', tileTemplate: '/tiles/{z}/{x}/{y}.webp' },
        { id: 'B1', tileTemplate: '/tiles/b1/{z}/{x}/{y}.webp' },
      ],
      subregions: [{ id: 'VL_1', key: 'test' }],
      points: [{ path: '/VL_1.json', sha256: 'hash', bytes: 2 }],
      coverage: {},
  ...
  locales: {
    'en-US': { path: '/en.json', sha256: 'hash', bytes: 2 },
    'zh-CN': { path: '/zh.json', sha256: 'hash', bytes: 2 },
  },
  controls: {
    'en-US': {
      layerSelect: 'Layer',
